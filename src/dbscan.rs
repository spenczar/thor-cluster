...
pub fn find_clusters_dbscan(points: Vec<XYPoint<f64>>, eps: f64, min_cluster_size: usize) -> Vec<i32> {
...
fn dbscan(points: &Vec<XYPoint<f64>>, tree: PointTree, eps: f32, min_cluster_size: usize) -> Vec<i32> {
	...
	let neighbors = tree.within_unsorted(
	    ...
	    eps, &distance::squared_euclidean
	);
